...
public class Maps2Activity extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    private List<String> attraction_lat;
    private List<String> attraction_lng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int attraction_no = getIntent().getIntExtra("attraction_no",0); //景點編號
        String name = getIntent().getStringExtra("name");   //景點名稱
        ...
        attraction_lat = Arrays.asList(getResources().getStringArray(R.array.att_lat));
        attraction_lng = Arrays.asList(getResources().getStringArray(R.array.att_lng));
        String la = attraction_lat.get(attraction_no);
        Float lat = Float.parseFloat(la);
        String lg = attraction_lng.get(attraction_no);
        Float lng = Float.parseFloat(lg);
        //place3 = new MarkerOptions().position(new LatLng(23.569478, 120.304146)).title("好住民宿 ");
        place2 = new MarkerOptions().position(new LatLng(lat, lng)).title(name);    //景點名稱
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent2 = new Intent(Maps2Activity.this, MainActivity.class);
    ...
    private boolean chkPlayService(){
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(Maps2Activity.this);
